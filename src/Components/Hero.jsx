  ...
  return (
    <div className="w-full h-[calc(100vh-8rem)] bg-green-200 flex flex-col-reverse lg:md:flex-row items-center justify-between  font-Lato mt-20 md:lg:mt-32">
      <div className="px-8 md:px-24 lg:px-32">
        ...
        >
          Welcome to Acient Healing
        </h1>
        <h1
          data-aos="zoom-in"
          data-aos-duration="1100"
          className="text-2xl md:text-3xl lg:text-5xl font-bold py-2 font-lora text-green-700"
        >
        ...
        <div className="py-4">
          <button
            ...
            className="py-2 lg:md:py-4 px-6 lg:md:px-10 bg-green-600 rounded-full text-white uppercase"
          >
            Book an Apointment
          </button>
        </div>
      ...
      <div className="grid grid-cols-2 place-content-center gap-7 pt-4 lg:md:pt-0 lg:md:gap-14 px-0 md:px-24 lg:px-32">
        <div
          ...
          className="w-44 h-44 lg:md:w-64 lg:md:h-64 bg-yellow-500 relative rounded-tl-[2rem]"
        >
          <img
            data-aos="zoom-in"
        ...
        <div
          data-aos="zoom-in"
          data-aos-duration="800"
          className="w-44 h-44 lg:md:w-64 lg:md:h-64 bg-orange-500 relative rounded-tr-[2rem]"
        >
          <img
            data-aos="zoom-in"
            data-aos-duration="1050"
        ...
        <div
          data-aos="zoom-in"
          data-aos-duration="800"
          className="w-44 h-44 lg:md:w-64 lg:md:h-64 bg-green-500 relative rounded-bl-[2rem]"
        >
          <img
            data-aos="zoom-in"
            data-aos-duration="1050"
        ...
        <div
          data-aos="zoom-in"
          data-aos-duration="800"
          className="w-44 h-44 lg:md:w-64 lg:md:h-64 bg-lime-500 relative rounded-br-[2rem]"
        >
          <img
            data-aos="zoom-in"
            data-aos-duration="1050"
