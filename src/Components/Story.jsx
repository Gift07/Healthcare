  ...
  return (
    <div className="w-full font-Lato pb-16">
      <div className="py-12 flex flex-col items-center justify-center">
        <h1 className="text-4xl font-lora font-medium text-green-500 hidden lg:md:flex">
          We believe in focussing on the person
          <br /> as much as the clinical condition.
        </h1>
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-lora font-medium text-green-500 flex text-center lg:md:hidden px-4">
          We believe in focussing on the person as much as the clinical
          condition.
        </h1>
        <hr className="w-28 h-2 bg-green-500 my-6" />
      </div>
