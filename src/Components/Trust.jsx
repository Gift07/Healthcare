const Trust = () => {
  return (
    <div className="w-full lg:md:h-[40rem] h-[92rem]">
        ...
        <div className="font-Lato bg-green-200 absolute lg:md:h-[38rem] h-full z-20 w-full bg-opacity-80 backdrop-blur-md">
          <div className="w-full flex flex-col items-center justify-center py-12">
            ...
            <h1
              ...
              className="font-lora text-3xl font-semibold"
            >
          ...
          <div className="w-full flex flex-col lg:md:flex-row items-center justify-center pb-12 pt-16 gap-x-8">
            ...
            <div
              ...
              className="relative pb-16 lg:md:py-0"
            >
              ...
              <div
                data-aos="zoom-in"
                data-aos-duration="1150"
                className="w-80 h-80 shadow-lg bg-white rounded-[2rem] p-3 pt-20"
              >
            ...
            <div
              data-aos="fade-up"
              data-aos-duration="1350"
              className="relative py-16 lg:md:py-0"
            >
            ...
            <div
              data-aos="fade-up"
              data-aos-duration="1350"
              className="relative pt-16 lg:md:py-0"
            >
              <div className="absolute w-full flex justify-center -top-4 lg:md:-top-16">
                <img
